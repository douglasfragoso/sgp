function Modal({titulo, texto, txtBtn01, onClickBtn01, txtBtn02, onClickBtn02, onClickBtnClose}) {
    return (
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        { onClickBtnClose && <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={onClickBtnClose}></button>}
                    </div>
